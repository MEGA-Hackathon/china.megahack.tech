...
function Resources() {
    ...
    useEffect(() => {
        ...
        setRowData([t('heroSection.tab1'),t('heroSection.tab2'),t('heroSection.tab3'),t('heroSection.tab4'),])
        setExpandableData([
            {
              title: t('faq.que1'),
              content: t('faq.ans1')
        ...
        setCardData([
            {
                ...
                title: t('intro.cardhead1'),
                text: t('intro.cardtext1'),
            },
            {
                imageUrl: '/Vector.png',
                title: t('intro.cardhead2'),
                text: t('intro.cardtext2'),
            },
            {
                imageUrl: '/union.svg',
                title: t('intro.cardhead3'),
                text: t('intro.cardtext3'),
            },
        ])
    }, [])
